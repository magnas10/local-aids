            ...
            <div className="volunteer-modal-header">
              ...
              <div className="event-card-compact">
                <div className="event-card-image">
                  <img 
                    src={volunteerEvent.imageUrl || '/api/placeholder/120/100'} 
                    alt={volunteerEvent.title}
                    onError={(e) => {
                      e.target.src = '/api/placeholder/120/100';
                    }}
                  />
                </div>
                <div className="event-card-details">
                  ...
                  <div className="event-meta-compact">
                    ...
                    <span className="meta-item">
                      ...
                      {volunteerEvent.duration || '2 hours'}
                    </span>
                    <span className="meta-item">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                      ...
                      {new Date(volunteerEvent.date).toLocaleDateString('en-US', { 
                        weekday: 'short', 
                        month: 'short', 
                        day: 'numeric' 
                      })}
            ...
            <form onSubmit={handleVolunteerSubmit} className="volunteer-form">
              <div className="form-group">
                <label htmlFor="volunteer-message">
                  ...
                  Introduce yourself and explain why you'd like to help
                </label>
                <textarea
              ...
              <div className="volunteer-modal-actions">
                ...
                >
                  ...
                  {submitStatus.type === 'success' ? 'Application Submitted!' : 'Submit Application'}
                </button>
              </div>
            </form>
          </div>
